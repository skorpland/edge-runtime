...
Deno.serve(async (req: Request) => {
  ...
  const session = new Powerbase.ai.Session(model ?? 'llama2');
...
curl --get "http://localhost:9998/power-ai-openaicompatible" \
--data-urlencode "prompt=write a short rap song about Powerbase, the Postgres Developer platform, as sung by Nicki Minaj" \
...
--data-urlencode 'prompt={"messages":[{"role":"user","content":"Tell me a joke about Powerbase!"}]}' \
--data-urlencode "stream=true" \
